...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    FlutterBranchSdk.setIdentity('ling_in_test');
  ...
  void initDeepLinkData() {
    metadata = BranchContentMetaData()
      ..addCustomMetadata('custom_data', 'your data')
  ...
  Widget build(BuildContext context) {
    return ScaffoldMessenger(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Branch Flutter SDK Demo'),
        ),
        body: Scrollbar(
